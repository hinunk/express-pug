    ...
    movies: [
      {
        ...
        _id: 1,
        poster:
          "https://img3.doubanio.com/view/movie_poster_cover/ipst/public/p2167448161.webp"
      },
      {
        title: "异形：契约",
        _id: 2,
...
app.get("/movie/:id", (req, res) => {
  res.render("detail", {
    ...
    movie: {
      ...
      language: "英语",
      flash:
        "https://static.youku.com/v201708241802.0/v/swf/upsplayer/player_yknpsv.swf",
      summary:
